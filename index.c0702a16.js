...
})({"emsqp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b837f9dec0702a16";
"use strict";
...
},{}],"jAINc":[function(require,module,exports) {
var _webImmediateJs = require("core-js/modules/web.immediate.js"); ///
var _sliderViewJs = require("./view/sliderView.js");
var _stateJs = require("../script/state.js");
var _genderSelectionviewJs = require("../script/view/genderSelectionview.js");
var _mainPageAndNavigationJs = require("./view/mainPageAndNavigation.js");
//Controlling slider component///
//step1 creating dots//
_sliderViewJs.createDotsFunction();
//step2 initial delay/
_sliderViewJs.delayerFunction();
//step 3/ activating initial dot
_sliderViewJs.activeDot(0);
//contorling gender selection section///
_genderSelectionviewJs.hoveringFunctionality();
//controling page copyright updating year//
_mainPageAndNavigationJs.insertYearForCopyRightText();

},{"../script/state.js":"d2RxD","core-js/modules/web.immediate.js":"49tUX","./view/sliderView.js":"gILCF","../script/view/genderSelectionview.js":"1vv1A","./view/mainPageAndNavigation.js":"hm5Va"}],"d2RxD":[function(require,module,exports) {
...
},{"./control.js":"jAINc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/sliderView.js":"gILCF"}],"gkKU3":[function(require,module,exports) {
...
},{}],"gILCF":[function(require,module,exports) {
///SLIDER COMPONENT//
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createDotsFunction", ()=>createDotsFunction);
parcelHelpers.export(exports, "goToSlide", ()=>goToSlide);
parcelHelpers.export(exports, "delayerFunction", ()=>delayerFunction);
parcelHelpers.export(exports, "activeDot", ()=>activeDot);
let pos = 0;
...
let dots = "";
const createDotsFunction = function() {
...
const goToSlide = function(pos, direction) {
    let itemNumber = pos;
    let newElClass = "";
    let elToGoAway = "";
    slides.forEach(function(s, i) {
...
const delayerFunction = async function() {
    setTimeout(function() {
        delayer = false;
    }, 1000);
};
...
const activeDot = function(dotNumber) {
    /*  active-dot */ let dotEls = dots;
...
},{}],"1vv1A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hoveringFunctionality", ()=>hoveringFunctionality);
...
const activatingImage = function(imgIndex, action) {
    ...
    if (action === "activate") imgToAddStyle.classList.add("hovering");
    else if (action === "remove") imgToAddStyle.classList.remove("hovering");
};
const hoveringFunctionality = function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hm5Va":[function(require,module,exports) {
//COPYRIGHT TEXT//
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "insertYearForCopyRightText", ()=>insertYearForCopyRightText);
...
const insertYearForCopyRightText = function() {
...
const openOrCloseUnderConstructionMessage = function(action) {
    if (action === "open") pendingSectionModal.classList.add("under-construction-modal-visible");
    else if (action === "close") pendingSectionModal.classList.remove("under-construction-modal-visible");
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["emsqp","jAINc"], "jAINc", "parcelRequireeafe")

//# sourceMappingURL=index.c0702a16.js.map
